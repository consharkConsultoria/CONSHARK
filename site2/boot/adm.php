...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php?user_id=$adm_id" class="logo d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <?php 
            ...
            if ($sql) {
              ...
              // Lógica para tratar falha na consulta
  ...
  $(function () {
    ...
    $('.btn[data-filter]').on('click', function() {
      ...
      $(this).addClass('active');
        ...
        <form action="barra-progresso.php?unique_id=<?php echo $user_id ?>&adm_id=<?php echo $adm_id ?>" method="post" class="form-barra">
          <input class="input-barra" name="valor_progesso" type="number" placeholder="Valor da barra">
          <input type="submit" class="sub-barra" name="barraProgresso" value="Alterar barra">
        </form>

        <form action="img-projeto.php?unique_id=<?php echo $user_id ?>&adm_id=<?php echo $adm_id ?>" enctype="multipart/form-data" method="post" class="form-img">
          <div id="containerImg">
            <img id="previewImg" src="#" alt="Prévia da imagem" style="display: none;">
          </div>
          <label class="lblForImg"for="imgProjeto"> Selecionar imagem</label>
          <input class="input-img" id="imgProjeto" name="img_projeto" type="file">

          <input type="submit" class="sub-barra" name="imgProjeto" value="Adicionar imagem">
        </form>

        <script>
          var file = document.getElementById("imgProjeto");
        ...
        <form action="atv-recente.php?unique_id=<?php echo $user_id ?>&adm_id=<?php echo $adm_id ?>" method="post" class="form-atv">
        <input class="input-atv" name="atv-data" type="text" placeholder="Digite a data">
        <input class="input-atv" name="atv-msg" type="text" placeholder="Digite a mensagem">
        <input class="input-atv" name="atv-cor" type="text" placeholder="Digite a cor da bolinha">
        <input type="submit" class="sub-barra" name="atv-input" value="Adicionar mensagem">
        </form>
